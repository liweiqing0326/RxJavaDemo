...
public class Test10Activity extends AppCompatActivity {
    ...
    @BindView(R.id.test12_btn1)
    Button test12Btn1;
    @BindView(R.id.test12_btn2)
    Button test12Btn2;
    @BindView(R.id.test12_btn3)
    Button test12Btn3;
    @BindView(R.id.test12_btn4)
    Button test12Btn4;
    @BindView(R.id.test12_btn5)
    Button test12Btn5;
    @BindView(R.id.test12_btn6)
    Button test12Btn6;
    @BindView(R.id.test12_btn7)
    Button test12Btn7;
    ...
    @OnClick({R.id.test12_btn1, R.id.test12_btn2, R.id.test12_btn3, R.id.test12_btn4, R.id.test12_btn5, R.id.test12_btn6, R.id.test12_btn7})

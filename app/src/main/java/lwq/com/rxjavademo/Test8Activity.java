...
public class Test8Activity extends AppCompatActivity {
    ...
    @BindView(R.id.test9_btn1)
    Button test9Btn1;
    @BindView(R.id.test9_btn21)
    Button test9Btn21;
    @BindView(R.id.test9_btn2)
    Button test9Btn2;
    @BindView(R.id.test9_btn3)
    Button test9Btn3;
    @BindView(R.id.test9_btn4)
    Button test9Btn4;
    @BindView(R.id.test9_btn5)
    Button test9Btn5;
    @BindView(R.id.test9_btn6)
    Button test9Btn6;
    @BindView(R.id.test9_btn7)
    Button test9Btn7;
    @BindView(R.id.test9_btn8)
    Button test9Btn8;
    @BindView(R.id.test9_btn9)
    Button test9Btn9;
    @BindView(R.id.test9_btn10)
    Button test9Btn10;
    @BindView(R.id.test9_btn11)
    Button test9Btn11;
    @BindView(R.id.test9_btn12)
    Button test9Btn12;
    @BindView(R.id.test9_btn13)
    Button test9Btn13;
    @BindView(R.id.test9_btn14)
    Button test9Btn14;
    @BindView(R.id.test9_btn15)
    Button test9Btn15;
    @BindView(R.id.test9_btn16)
    Button test9Btn16;
    @BindView(R.id.test9_btn17)
    Button test9Btn17;
    @BindView(R.id.test9_btn18)
    Button test9Btn18;
    @BindView(R.id.test9_btn19)
    Button test9Btn19;
    @BindView(R.id.test9_btn20)
    Button test9Btn20;
    ...
    @OnClick({R.id.test9_btn1, R.id.test9_btn21, R.id.test9_btn2, R.id.test9_btn3, R.id.test9_btn4, R.id.test9_btn5, R.id.test9_btn6, R.id.test9_btn7, R.id.test9_btn8, R.id.test9_btn9, R.id.test9_btn10, R.id.test9_btn11, R.id.test9_btn12, R.id.test9_btn13, R.id.test9_btn14, R.id.test9_btn15, R.id.test9_btn16, R.id.test9_btn17, R.id.test9_btn18, R.id.test9_btn19, R.id.test9_btn20})
